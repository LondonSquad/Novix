...
interface AuthApi {
    ...
    suspend fun validateWithLogin(@Body request: CreateSessionWithLoginRequest): Boolean

    @POST("authentication/session/new")
    suspend fun createSession(@Body token: RequestTokenResponse): SessionResponse
