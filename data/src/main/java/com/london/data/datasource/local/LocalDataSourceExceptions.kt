...
import com.london.data.datasource.local.LocalDataSourceMessages.GET_ACTOR_BY_QUERY
...
import com.london.data.datasource.local.LocalDataSourceMessages.GET_MOVIE_BY_QUERY
...
import com.london.data.datasource.local.LocalDataSourceMessages.GET_TV_SHOW_BY_QUERY
...
object LocalDataSourceMessages {
    ...
    const val GET_MOVIE_BY_QUERY = "Failed to retrieve movie by query from the local database."
    ...
    const val GET_TV_SHOW_BY_QUERY = "Failed to retrieve TV show by query from the local database."
    ...
    const val GET_ACTOR_BY_QUERY = "Failed to retrieve actor by query from the local database."
}