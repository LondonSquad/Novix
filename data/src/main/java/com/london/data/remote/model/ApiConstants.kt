...
object ApiConstants {
    ...
    const val TV_SHOW_SEASON_PATH = "3/tv/{tv_id}/season/{season_number}"
    const val TV_SHOW_IMAGE = "3/tv/{tv_id}/images"
    const val TV_SHOW_EPISODE_PATH = "3/tv/{tv_id}/season/{season_number}/episode/{episode_number}"
    const val TV_SHOW_VIDEO_PATH = "3/tv/{tv_show_id}/season/{season_number}/videos"
