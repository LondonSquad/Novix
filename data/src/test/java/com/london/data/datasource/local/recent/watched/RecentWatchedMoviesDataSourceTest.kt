...
class RecentWatchedMoviesDataSourceTest {
    ...
    fun `getAll should return list of RecentWatchedTvShowLocal when dao returns list`() = runTest {
        // Given
        coEvery { recentWatchedMoviesDao.getAll() } returns recentWatchedMovieLocalList
        // When
        val result = recentWatchedMoviesDataSource.getAll()
        // Then
    ...
    fun `getAll should return empty list when dao returns empty list`() = runTest {
        // Given
        coEvery { recentWatchedMoviesDao.getAll() } returns emptyList()
        // When
        val result = recentWatchedMoviesDataSource.getAll()
        // Then
    ...
    fun `getAll should return empty list when dao throws exception`() = runTest {
        // Given
        coEvery { recentWatchedMoviesDao.getAll() } throws Exception()
        // When
        val result = recentWatchedMoviesDataSource.getAll()
        // Then
        assertThat(result).isEmpty()
