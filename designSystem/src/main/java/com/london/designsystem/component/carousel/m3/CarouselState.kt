package com.london.designsystem.component.carousel.m3
 ...
 *   snapped position.
 * @param itemCount the number of items this Carousel.kt will have.
 */
...
class CarouselState(
    ...
    /**
     * Scroll animate to a given [item]. If the [item] is too far away from [currentItem], Carousel.kt
 ...
 * offsets in Carousel.kt due keyline shifting, a scroll distance from one index to another cannot be
...
/**
 * Interface to hold information about a Carousel.kt item and its size.
 *
